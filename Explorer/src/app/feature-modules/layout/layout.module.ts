...
@NgModule({
	declarations: [HomeComponent, NavbarComponent, RatingTheAppComponent, FooterComponent, NotificationsComponent, CustomAlertComponent],
	imports: [CommonModule, MaterialModule, RouterModule, FormsModule, SharedModule, MarketplaceModule],
	exports: [NavbarComponent, HomeComponent, RatingTheAppComponent, FooterComponent, NotificationsComponent, CustomAlertComponent]
})
