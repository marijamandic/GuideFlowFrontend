...
@NgModule({
	declarations: [HomeComponent, NavbarComponent, RatingTheAppComponent, FooterComponent, NotificationsComponent],
	imports: [CommonModule, MaterialModule, RouterModule, FormsModule, SharedModule, MarketplaceModule],
	exports: [NavbarComponent, HomeComponent, RatingTheAppComponent, FooterComponent, NotificationsComponent]
})
