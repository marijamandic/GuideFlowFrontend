  ...
  constructor(private authService: AuthService, private marketPlaceService: MarketplaceService,
	...
	tours = [
		...
		},
		{
			...
			description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. ',
			rating: 8.1,
			reviews: 'Very good, 180 reviews',
			imageUrl: 'assets/images/tour7.jpg'
		},
		{
			id: 5,
			name: 'Lorem Ipsum',
			...
			rating: 7.5,
			reviews: 'Good, 100 reviews',
			imageUrl: 'assets/images/tour8.jpg'
		},
		{
			id: 6,
			name: 'Lorem Ipsum',
			...
			rating: 8.3,
			reviews: 'Very good, 180 reviews',
			imageUrl: 'assets/images/tour9.jpg'
		}
	];
	...
	clubs = [
		...
		},
		{
			...
			rating: 9.2,
			reviews: 'Excellent, 150 reviews',
			imageUrl: 'assets/images/club2.jpg'
		},
		{
			name: 'Lorem Ipsum',
			description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. ',
			rating: 7.5,
			reviews: 'Good, 100 reviews',
			imageUrl: 'assets/images/club3.jpg'
		},
		{
			name: 'Lorem Ipsum',
			description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. ',
			rating: 8.1,
			reviews: 'Very good, 180 reviews',
			imageUrl: 'assets/images/club4.jpg'
		},
		{
			name: 'Lorem Ipsum',
			description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. ',
			rating: 7.5,
			reviews: 'Good, 100 reviews',
			imageUrl: 'assets/images/club5.jpg'
		},
		{
			name: 'Lorem Ipsum',
			description: 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. ',
			rating: 8.3,
			reviews: 'Very good, 180 reviews',
			imageUrl: 'assets/images/club6.jpg'
		}
	];
